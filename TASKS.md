...
> Auto-generated by the Elyos task-decomposition agent (2026-06-29). Every TASKS.md row now has a
> corresponding schema-valid `tasks/<id>.json`. All 25 files pass the Elyos validation harness
> (`validate-tasks.mjs`). The pre-existing seed file (`food-security-briefs-styleguide-002.json`)
> was preserved as-is.
>
> **Schema note:** The `type` column shows `translation` for `i18n-015` and `i18n-024`. The Elyos
> task schema does not include `translation` as a valid `type` enum value — `translation` is a
> `deliverable` value. Both tasks are authored as `type: "writing"` + `deliverable: "translation"`
> in the JSON files, which is the correct schema-valid mapping.
>
> **Fan-out note:** `brief-016` (#4–#5) and `scale-020` (#6–#8) each emit ONE representative task
> JSON because PLAN.md does not explicitly enumerate the specific indicators for those slots;
> they are selected from TOPIC-CATALOG.md after further triage per the fan-out policy.

| File | ID | Milestone | Type | Deliverable | Status |
| --- | --- | --- | --- | --- | --- |
| `tasks/food-security-briefs-reviewer-001.json` | food-security-briefs-reviewer-001 | M0 | research | document | open |
| `tasks/food-security-briefs-styleguide-002.json` | food-security-briefs-styleguide-002 | M0 | writing | document | open |
| `tasks/food-security-briefs-statcheck-003.json` | food-security-briefs-statcheck-003 | M0 | design-spec | document | open |
| `tasks/food-security-briefs-gate-004.json` | food-security-briefs-gate-004 | M0 | design-spec | document | open |
| `tasks/food-security-briefs-dataspec-005.json` | food-security-briefs-dataspec-005 | M0 | design-spec | document | open |
| `tasks/food-security-briefs-harness-006.json` | food-security-briefs-harness-006 | M0 | code | pr | open |
| `tasks/food-security-briefs-outreach-007.json` | food-security-briefs-outreach-007 | M0 | research | document | open |
| `tasks/food-security-briefs-pilot-008.json` | food-security-briefs-pilot-008 | M0 | data | dataset | open |
| `tasks/food-security-briefs-snapshot-009.json` | food-security-briefs-snapshot-009 | M1 | code | pr | open |
| `tasks/food-security-briefs-triage-010.json` | food-security-briefs-triage-010 | M1 | research | document | open |
| `tasks/food-security-briefs-brief-011.json` | food-security-briefs-brief-011 | M1 | data | dataset | open |
| `tasks/food-security-briefs-brief-012.json` | food-security-briefs-brief-012 | M1 | data | dataset | open |
| `tasks/food-security-briefs-partner-013.json` | food-security-briefs-partner-013 | M1 | research | document | open |
| `tasks/food-security-briefs-template-014.json` | food-security-briefs-template-014 | M2 | design-spec | document | open |
| `tasks/food-security-briefs-i18n-015.json` | food-security-briefs-i18n-015 | M2 | writing | translation | open |
| `tasks/food-security-briefs-brief-016.json` | food-security-briefs-brief-016 | M2 | data | dataset | open |
| `tasks/food-security-briefs-source-017.json` | food-security-briefs-source-017 | M2 | research | document | open |
| `tasks/food-security-briefs-reuse-018.json` | food-security-briefs-reuse-018 | M3 | research | document | open |
| `tasks/food-security-briefs-refresh-019.json` | food-security-briefs-refresh-019 | M3 | maintenance | document | open |
| `tasks/food-security-briefs-scale-020.json` | food-security-briefs-scale-020 | M3 | data | dataset | open |
| `tasks/food-security-briefs-catalog-021.json` | food-security-briefs-catalog-021 | Backlog | research | document | open |
| `tasks/food-security-briefs-dash-022.json` | food-security-briefs-dash-022 | Backlog | code | pr | open |
| `tasks/food-security-briefs-validator-023.json` | food-security-briefs-validator-023 | Backlog | code | pr | open |
| `tasks/food-security-briefs-i18n-024.json` | food-security-briefs-i18n-024 | Backlog | writing | translation | open |
| `tasks/food-security-briefs-region-025.json` | food-security-briefs-region-025 | Backlog | data | dataset | open |
